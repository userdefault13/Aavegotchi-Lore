...
export function buildStoryboardFramePrompt({ sceneTitle, sceneContent, loreTitles = [], zone = '' }) {
  ...
  return `pixel: Gotchiverse storyboard panel — ${sceneTitle || 'scene'}${zoneBit}${loreBit}${context}, cinematic 16:9 composition, Aavegotchi pixel art, purple and cyan palette`;
}
